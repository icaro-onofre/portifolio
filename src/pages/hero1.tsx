  ...
  return (
    ...
    >
      <div className=" grid grid-cols-12 gap-5 bg-bgblue">
        ...
        <div className="flex bg-lightblue h-screen right-0 w-44  justify-center">
          <p className="font-libre font-bold text-1xl text-bgblue w-32 align-middle text-left mt-3">
        ...
        <div className="col-start-3 col-end-4">
          <div className="flex flex-row absolute bottom-10 mt-56 items-center">
            <p className=" font-bold font-libre text-blue text-3xl w-28">
              Ícaro Onofre Silva.
            </p>
